...
namespace ASP.net_MVC_basics.Migrations
{
    ...
    [Migration("20220120225008_EF6 Add Language")]
    partial class EF6AddLanguage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP.net_MVC_basics.Data.LanguageModel", b =>
                {
                    ...
                    b.Property<int?>("LanguageModelLanguageId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PeopleModelPersonId")
                        .HasColumnType("int");

                    b.HasKey("LanguageId");

                    b.HasIndex("LanguageModelLanguageId");

                    b.HasIndex("PeopleModelPersonId");
            ...
            modelBuilder.Entity("ASP.net_MVC_basics.Data.LanguageModel", b =>
                {
                    b.HasOne("ASP.net_MVC_basics.Data.LanguageModel", null)
                        .WithMany("listPeople")
                        .HasForeignKey("LanguageModelLanguageId");

                    b.HasOne("ASP.net_MVC_basics.Data.PeopleModel", null)
                        .WithMany("listLanguage")
                        .HasForeignKey("PeopleModelPersonId");
                });
